...
def plot_slots(path, fixed_paths, folds, runs, click_model, num_interactions, color, plot_ind):
    ...
    plot("results/SDBN/PDGD/abrupt_group_change_50k/intent1", folds, runs, click_model, num_interactions, color[4], plot_ind, interval=(0, 200))
    plot("results/SDBN/PDGD/abrupt_group_change_50k/intent2", folds, runs, click_model, num_interactions, color[3],
         plot_ind, interval=(0, 200))
    plot("results/SDBN/PDGD/abrupt_group_change_50k/intent3", folds, runs, click_model, num_interactions, color[2],
         plot_ind, interval=(0, 200))
    plot("results/SDBN/PDGD/abrupt_group_change_50k/intent4", folds, runs, click_model, num_interactions, color[1],
         plot_ind, interval=(0, 200))
    ...
    if plot_ind == 0:
        ...
        # plt.legend(['PDGD',
        #             "intent2"], loc='lower right', ncol=3)

        plt.legend([
                    "intent1",
                    "intent2",
                    "intent3",
                    "intent4"], loc='lower right', ncol=3)
    else:
        plt.yticks([])
    ax = plt.twiny()
...
if __name__ == "__main__":
    ...
    fixed_path2 = "results/SDBN/COLTR/group_fixed_200k/group2"
    fixed_path3 = "results/SDBN/COLTR/group_fixed_200k/group3"
    fixed_path4 = "results/SDBN/COLTR/group_fixed_200k/group4"
    ...
    path2 = "results/SDBN/PDGD/abrupt_group_change_50k/intent1"
